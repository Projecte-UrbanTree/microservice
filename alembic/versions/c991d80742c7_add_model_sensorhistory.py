...
def upgrade() -> None:
    ...
    op.create_table('sensorhistory',
                    ...
                    sa.Column('deduplication_id', sqlmodel.sql.sqltypes.AutoString(
                        length=100), nullable=False),
                    sa.Column('time', sa.DateTime(), nullable=False),
                    sa.Column('tenant_id', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    sa.Column('tenant_name', sqlmodel.sql.sqltypes.AutoString(
                        length=100), nullable=True),
                    sa.Column('application_id', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    sa.Column('application_name', sqlmodel.sql.sqltypes.AutoString(
                        length=100), nullable=True),
                    sa.Column('device_profile_id', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    sa.Column('device_profile_name', sqlmodel.sql.sqltypes.AutoString(
                        length=100), nullable=True),
                    sa.Column('device_name', sqlmodel.sql.sqltypes.AutoString(
                        length=100), nullable=True),
                    sa.Column('dev_eui', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    sa.Column('device_class_enabled', sqlmodel.sql.sqltypes.AutoString(
                        length=20), nullable=True),
                    sa.Column('tags', sa.JSON(), nullable=True),
                    sa.Column('dev_addr', sqlmodel.sql.sqltypes.AutoString(
                        length=20), nullable=True),
                    ...
                    sa.Column('ph1_soil', sa.Float(), nullable=True),
                    sa.Column('gateway_id', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    ...
                    sa.Column('context', sqlmodel.sql.sqltypes.AutoString(
                        length=50), nullable=True),
                    sa.Column('crc_status', sqlmodel.sql.sqltypes.AutoString(
                        length=20), nullable=True),
                    sa.Column('frequency', sa.Integer(), nullable=True),
                    sa.Column('modulation', sa.JSON(), nullable=True),
                    sa.Column('region_config_id', sqlmodel.sql.sqltypes.AutoString(
                        length=20), nullable=True),
